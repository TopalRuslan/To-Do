...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY",
    "django-insecure-r$dy+o3()+l2cln#l47frc#vz-4f_0x9y_n(h(a2(*b8jrx918",
)
...
# PostgreSQL is used when POSTGRES_HOST is set (Kubernetes / Docker),
# otherwise the project falls back to local SQLite.
